# Python program to create a simple snake game + pac man using pygame
...
invincible_spawn = True

# Control variables for invincible spawn timing
invincible_visible = False
...
while True:
    ...
    if snake_position[0] == fruit_position[0] and snake_position[1] == fruit_position[1]:
        # Increment score and set fruit_spawn to False
        score += 10
        fruit_spawn = False
    ...
    if invincible_visible and current_time - invincible_start_time >= 5:
        invincible_visible = False  # Hide invincible after 5 seconds

    # Check if snake eats the invincible
    if (snake_position[0] == invincible_position[0] and 
